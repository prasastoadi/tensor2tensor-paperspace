...
--model_dir=/storage/train/BS4096_Max256_LR.2_LRWS8000_single_notok_nothrott \
--source=/storage/corpus/dev/IWSLT17.TED.dev2010.en-id/IWSLT17.TED.dev2010.en-id.en \
--translations_dir=/storage/translated/dev/BS4096_Max256_LR.2_LRWS8000_single_notok_nothrott/IWSLT17.TED.dev2010.en-id \
--beam_size=4 \
--alpha=0.6 \
--model=transformer \
...
--translations_dir=/storage/translated/dev/BS4096_Max256_LR.2_LRWS8000_single_notok_nothrott/IWSLT17.TED.dev2010.en-id \
--event_dir=/storage/translated/dev/BS4096_Max256_LR.2_LRWS8000_single_notok_nothrott/IWSLT17.TED.dev2010.en-id