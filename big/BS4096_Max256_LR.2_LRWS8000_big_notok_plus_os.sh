...
--output_dir=/storage/train/BS4096_Max256_LR.2_LRWS8000_big_notok_plus_os/ \
--eval_steps=100 \
...
--t2t_usr_dir=usrdir \
--problem=translate_enid_iwslt32k_notok_plus_os \
--model_dir=/storage/train/BS4096_Max256_LR.2_LRWS8000_big_notok_plus_os \
--source=/storage/corpus/dev/IWSLT17.TED.dev2010.en-id/IWSLT17.TED.dev2010.en-id.en \
--translations_dir=/storage/translated/dev/BS4096_Max256_LR.2_LRWS8000_big_notok_plus_os/IWSLT17.TED.dev2010.en-id \
--beam_size=4 \
--alpha=0.6 \
--model=transformer \
--data_dir=/storage/data_notok_plus_os \
...
--translations_dir=/storage/translated/dev/BS4096_Max256_LR.2_LRWS8000_big_notok_plus_os/IWSLT17.TED.dev2010.en-id \
--event_dir=/storage/translated/dev/BS4096_Max256_LR.2_LRWS8000_big_notok_plus_os/IWSLT17.TED.dev2010.en-id