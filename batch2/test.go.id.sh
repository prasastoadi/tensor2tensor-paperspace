...
--translations_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/test.go.id \
--beam_size=4 \
--alpha=0.6 \
--model=transformer \
...
--translations_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/test.go.id \
--event_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/test.go.id
...
--translations_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/tst2017plus \
--beam_size=4 \
--alpha=0.6 \
--model=transformer \
--data_dir=/storage/data_notok_plus_os \
...
--translations_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/tst2017plus \
--event_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/tst2017plus
...
--translations_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/tst2010 \
--beam_size=4 \
--alpha=0.6 \
--model=transformer \
--data_dir=/storage/data_notok_plus_os \
...
--translations_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/tst2010 \
--event_dir=/storage/translated/test/BS4096_Max256_LR.2_LRWS8000_single_notok_plus_os/tst2010