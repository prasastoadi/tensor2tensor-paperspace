...
t2t-trainer \
--problem=translate_enid_iwslt32k_bppt \
--model=transformer \
--hparams_set=transformer_base \
--data_dir=/storage/data_bppt/ \
--output_dir=/storage/train/BS4096_Max256_LR.2_LRWS8000_single_bppt/ \
--eval_steps=100 \
...
--t2t_usr_dir=usrdir \
--problem=translate_enid_iwslt32k_bppt \
--model_dir=/storage/train/BS4096_Max256_LR.2_LRWS8000_single_bppt \
